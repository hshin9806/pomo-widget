...
Download `POMO.dmg` from the [latest release](../../releases/latest) and drag POMO into Applications.
...
macOS 13 이상이 필요합니다. [최신 릴리스](../../releases/latest)에서 `POMO.dmg`를 받아 응용 프로그램 폴더에 넣으면 됩니다.
